...
using ExecuteMultiLevelFeedbackQueue = MultiLevelFeedbackQueue<ExecuteTimeGetter>;
...
using SpillMultiLevelFeedbackQueue = MultiLevelFeedbackQueue<SpillTimeGetter>;
} // namespace DB
